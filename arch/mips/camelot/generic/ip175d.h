...
// Plaster Network additions
#define SIOCGPVALSET		SIOCDEVPRIV+0x4
#define	SIOCGPVALGET		SIOCDEVPRIV+0x5
#define SIOCGPDIRSET		SIOCDEVPRIV+0x6
#define SIOCGPDIRGET		SIOCDEVPRIV+0x7
#define SIOCGPSELSET		SIOCDEVPRIV+0x8
#define SIOCGPSELGET		SIOCDEVPRIV+0x9
#endif
